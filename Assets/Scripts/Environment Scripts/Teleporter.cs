            ...
            if (operation.isDone)
            {
                ...
                if (nextScene.IsValid())
                {
                    ...
                    if (teleporter != null)
                    {
                        ...
                        GameManager.Instance.cameraManager.FindNewCameras(cam);
                    }
                }
                yield return null;
                HUDController.Instance.FadeOut();

                StartCoroutine(GameManager.Instance.sceneManager.UnloadScenesExceptBattle());
                
                EventManager.Instance.overworldEvents.EnterNewScene();
            }
        }
